...
[![Build Status](https://travis-ci.org/JonasMoss/publipha.svg?branch=master)](https://travis-ci.org/JonasMoss/publipha)
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/JonasMoss/publipha?branch=master&svg=true)](https://ci.appveyor.com/project/JonasMoss/publipha)
...
*  `phma` does random effects meta-analysis under a certain model of *p*-hacking
   ...
   on the forthcoming paper (Moss and De Bin, 2019).
