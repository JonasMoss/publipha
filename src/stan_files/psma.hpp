...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(86, 1, "restart", "/chunks/psma_likelihoods.stan");
    reader.add_event(222, 137, "end", "/chunks/psma_likelihoods.stan");
    reader.add_event(222, 2, "restart", "model_psma");
    reader.add_event(289, 67, "end", "model_psma");
    return reader;
}
...
normal_lnorm(const T0__& theta,
    ...
    try {
        ...
        vector<local_scalar_t__> summands((k - 1));
...
template <typename T0__, typename T1__, typename T2__, typename T3__, typename T4__>
typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T4__>::type>::type
fnormal_lnorm(const T0__& theta,
                  const T1__& tau,
                  const T2__& sigma,
                  const std::vector<T3__>& alpha,
                  const Eigen::Matrix<T4__, Eigen::Dynamic,1>& weights, std::ostream* pstream__) {
    typedef typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T4__>::type>::type local_scalar_t__;
    typedef local_scalar_t__ fun_return_scalar_t__;
    const static bool propto__ = true;
    (void) propto__;
    ...
    try {
        ...
        for (int i = 2; i <= (k - 1); ++i) {
            ...
            stan::math::assign(cdf, fnormal_cdf(cutoff,theta,stan::math::sqrt((pow(tau,2) + pow(sigma,2))), pstream__));
            current_statement_begin__ = 182;
            stan::model::assign(summands, 
                        stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                        (cdf * (get_base1(weights,i,"weights",1) - get_base1(weights,(i - 1),"weights",1))), 
                        "assigning variable summands");
        }
...
struct fnormal_lnorm_functor__ {
    template <typename T0__, typename T1__, typename T2__, typename T3__, typename T4__>
        typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T4__>::type>::type
    operator()(const T0__& theta,
                  const T1__& tau,
                  const T2__& sigma,
                  const std::vector<T3__>& alpha,
                  const Eigen::Matrix<T4__, Eigen::Dynamic,1>& weights, std::ostream* pstream__) const {
        return fnormal_lnorm(theta, tau, sigma, alpha, weights, pstream__);
    }
};

template <bool propto, typename T0__, typename T1__, typename T2__, typename T3__, typename T4__, typename T5__>
typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T4__, T5__>::type>::type
psma_fnormal_prior_mini_lpdf(const T0__& theta,
                                 const T1__& theta0,
                                 const T2__& tau,
                                 const T3__& sigma,
                                 const std::vector<T4__>& alpha,
                                 const Eigen::Matrix<T5__, Eigen::Dynamic,1>& weights, std::ostream* pstream__) {
    typedef typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T4__, T5__>::type>::type local_scalar_t__;
    typedef local_scalar_t__ fun_return_scalar_t__;
    const static bool propto__ = true;
    (void) propto__;
    ...
    try {
        ...
        stan::math::initialize(y, DUMMY_VAR__);
        stan::math::fill(y,DUMMY_VAR__);
        stan::math::assign(y,fnormal_lpdf(theta,theta0,tau, pstream__));
        ...
        stan::math::initialize(normalizer, DUMMY_VAR__);
        stan::math::fill(normalizer,DUMMY_VAR__);
        stan::math::assign(normalizer,fnormal_lnorm(theta0,tau,sigma,alpha,weights, pstream__));
...
psma_fnormal_prior_mini_lpdf(const T0__& theta,
                                 ...
                                 const std::vector<T4__>& alpha,
                                 const Eigen::Matrix<T5__, Eigen::Dynamic,1>& weights, std::ostream* pstream__) {
    return psma_fnormal_prior_mini_lpdf<false>(theta,theta0,tau,sigma,alpha,weights, pstream__);
}


struct psma_fnormal_prior_mini_lpdf_functor__ {
    template <bool propto, typename T0__, typename T1__, typename T2__, typename T3__, typename T4__, typename T5__>
        typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T4__, T5__>::type>::type
    operator()(const T0__& theta,
                                 const T1__& theta0,
                                 ...
                                 const T3__& sigma,
                                 const std::vector<T4__>& alpha,
                                 const Eigen::Matrix<T5__, Eigen::Dynamic,1>& weights, std::ostream* pstream__) const {
        return psma_fnormal_prior_mini_lpdf(theta, theta0, tau, sigma, alpha, weights, pstream__);
    }
};

template <bool propto, typename T0__, typename T1__, typename T2__, typename T3__, typename T4__>
typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T4__>::type>::type
psma_fnormal_mini_lpdf(const T0__& x,
                           const T1__& theta,
                           const T2__& sigma,
                           const std::vector<T3__>& alpha,
                           const Eigen::Matrix<T4__, Eigen::Dynamic,1>& weights, std::ostream* pstream__) {
    ...
    try {
        ...
        stan::math::initialize(u, DUMMY_VAR__);
        stan::math::fill(u,DUMMY_VAR__);
        stan::math::assign(u,(2 * (1 - normal_cdf(x,0,sigma))));
        ...
        for (int i = 1; i <= (k - 1); ++i) {
            ...
            if (as_bool((primitive_value(logical_lt(get_base1(alpha,i,"alpha",1),u)) && primitive_value(logical_lte(u,get_base1(alpha,(i + 1),"alpha",1)))))) {
                ...
                stan::math::assign(y, (y + stan::math::log(get_base1(weights,i,"weights",1))));
...
psma_fnormal_mini_lpdf(const T0__& x,
                           ...
                           const std::vector<T3__>& alpha,
                           const Eigen::Matrix<T4__, Eigen::Dynamic,1>& weights, std::ostream* pstream__) {
    return psma_fnormal_mini_lpdf<false>(x,theta,sigma,alpha,weights, pstream__);
}


struct psma_fnormal_mini_lpdf_functor__ {
    template <bool propto, typename T0__, typename T1__, typename T2__, typename T3__, typename T4__>
        typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T4__>::type>::type
    operator()(const T0__& x,
                           const T1__& theta,
                           ...
                           const std::vector<T3__>& alpha,
                           const Eigen::Matrix<T4__, Eigen::Dynamic,1>& weights, std::ostream* pstream__) const {
        return psma_fnormal_mini_lpdf(x, theta, sigma, alpha, weights, pstream__);
    }
};

template <bool propto, typename T0__, typename T1__, typename T2__, typename T3__, typename T4__>
typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T4__>::type>::type
psma_fnormal_maxi_lpdf(const T0__& x,
                           const T1__& theta,
                           const T2__& sigma,
                           const std::vector<T3__>& alpha,
                           const Eigen::Matrix<T4__, Eigen::Dynamic,1>& weights, std::ostream* pstream__) {
    ...
    try {
        ...
        stan::math::initialize(y, DUMMY_VAR__);
        stan::math::fill(y,DUMMY_VAR__);
        stan::math::assign(y,psma_fnormal_mini_lpdf(x,theta,sigma,alpha,weights, pstream__));
        ...
        stan::math::initialize(normalizer, DUMMY_VAR__);
        stan::math::fill(normalizer,DUMMY_VAR__);
        stan::math::assign(normalizer,fnormal_lnorm(theta,0,sigma,alpha,weights, pstream__));
...
psma_fnormal_maxi_lpdf(const T0__& x,
                           ...
                           const std::vector<T3__>& alpha,
                           const Eigen::Matrix<T4__, Eigen::Dynamic,1>& weights, std::ostream* pstream__) {
    return psma_fnormal_maxi_lpdf<false>(x,theta,sigma,alpha,weights, pstream__);
}


struct psma_fnormal_maxi_lpdf_functor__ {
    template <bool propto, typename T0__, typename T1__, typename T2__, typename T3__, typename T4__>
        typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T4__>::type>::type
    operator()(const T0__& x,
                           const T1__& theta,
                           ...
                           const std::vector<T3__>& alpha,
                           const Eigen::Matrix<T4__, Eigen::Dynamic,1>& weights, std::ostream* pstream__) const {
        return psma_fnormal_maxi_lpdf(x, theta, sigma, alpha, weights, pstream__);
    }
};

#include <meta_header.hpp>
 class model_psma : public prob_grad {
private:
    int N;
    int k;
    vector<double> alpha;
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("weights")))
            throw std::runtime_error("variable weights missing");
        vals_r__ = context__.vals_r("weights");
        pos__ = 0U;
        validate_non_negative_index("weights", "(k - 1)", (k - 1));
        context__.validate_dims("initialization", "weights", "vector_d", context__.to_vec((k - 1)));
        vector_d weights(static_cast<Eigen::VectorXd::Index>((k - 1)));
        for (int j1__ = 0U; j1__ < (k - 1); ++j1__)
            weights(j1__) = vals_r__[pos__++];
        try {
            writer__.positive_ordered_unconstrain(weights);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable weights: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  eta(static_cast<Eigen::VectorXd::Index>((k - 1)));
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                if (as_bool(logical_eq(get_base1(likelihood,n,"likelihood",1),0))) {
                    ...
                    lp_accum__.add(psma_fnormal_prior_mini_lpdf<propto__>(get_base1(theta,n,"theta",1), theta0, tau, stan::math::sqrt(get_base1(vi,n,"vi",1)), alpha, eta, pstream__));
                    current_statement_begin__ = 270;
                    lp_accum__.add(psma_fnormal_mini_lpdf<propto__>(get_base1(yi,n,"yi",1), get_base1(theta,n,"theta",1), stan::math::sqrt(get_base1(vi,n,"vi",1)), alpha, eta, pstream__));
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vector_d weights = in__.positive_ordered_constrain((k - 1));
        vector<double> theta;
        size_t dim_theta_0__ = N;
        for (size_t k_0__ = 0; k_0__ < dim_theta_0__; ++k_0__) {
            theta.push_back(in__.scalar_constrain());
        ...
        vars__.push_back(tau);
            ...
            vars__.push_back(weights[k_0__]);
            }
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  log_lik_marginal(static_cast<Eigen::VectorXd::Index>(N));
            (void) log_lik_marginal;  // dummy to suppress unused var warning
            ...
            for (int k_0__ = 0; k_0__ < N; ++k_0__) {
            vars__.push_back(log_lik_marginal[k_0__]);
            }
            for (int k_0__ = 0; k_0__ < N; ++k_0__) {
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= (k - 1); ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "weights" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        ...
        for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "log_lik_marginal" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
            param_name_stream__.str(std::string());
