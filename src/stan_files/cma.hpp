...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_cma");
    ...
    reader.add_event(86, 2, "restart", "model_cma");
    reader.add_event(144, 58, "end", "model_cma");
    return reader;
}
...
#include <meta_header.hpp>
 class model_cma : public prob_grad {
private:
    int N;
    int k;
    vector<double> alpha;
    ...
    double tau_sd;
public:
    model_cma(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_cma_namespace::model_cma";
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                if (as_bool(logical_eq(get_base1(likelihood,n,"likelihood",1),0))) {
                    ...
                    lp_accum__.add(normal_lpdf<propto__>(get_base1(yi,n,"yi",1), get_base1(theta,n,"theta",1), stan::math::sqrt(get_base1(vi,n,"vi",1))));
                } else if (as_bool(logical_eq(get_base1(likelihood,n,"likelihood",1),1))) {

                    current_statement_begin__ = 125;
                    lp_accum__.add(fnormal_lpdf<propto__>(get_base1(yi,n,"yi",1), get_base1(theta,n,"theta",1), stan::math::sqrt(get_base1(vi,n,"vi",1)), pstream__));
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_cma_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(log_lik, 
                            ...
                            normal_log(get_base1(yi,n,"yi",1),get_base1(theta,n,"theta",1),stan::math::sqrt(get_base1(vi,n,"vi",1))), 
...
typedef model_cma_namespace::model_cma stan_model;
